package Hardware.SmartDevices.SmartVuforia;
...
public class SmartPhoneVuforia extends SmartDevice {
    ...
    public SmartPhoneVuforia(HardwareMap hardwareMap){
    ...
    public void calibrate() {
        ...
        vuforia.enableConvertFrameToFormat(PIXEL_FORMAT.RGB565);
        vuforia.setFrameQueueCapacity(128);
    ...
    public void update() {
        ...
        if (targetVisible) {
            ...
            position.set(translation.get(0) / mmPerInch, translation.get(1) / mmPerInch, translation.get(2) / mmPerInch);
